        ...
        <div class="panel-heading" style="display: flex; justify-content: space-between;">
          ...
          <div class="modal fade" id="modalCreate" tabindex="-1" role="dialog"
            ...
            <div class="modal-dialog" role="document">
              <form class="modal-content" action="{{ route('admin.lectures.store') }}" method="POST">
          ...
          <tr>
            ...
            <td>
              ...
              <div class="modal fade" id="modalUpdate{{$lecture->id}}" tabindex="-1" role="dialog"
                ...
                <div class="modal-dialog" role="document">
                  <form class="modal-content" action="{{ route('admin.lectures.update', $lecture->id) }}" method="POST">
                    <div class="modal-header">
                      <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span
                          aria-hidden="true">&times;</span></button>
              ...
              <div class="modal fade" id="modalDelete{{$lecture->id}}" tabindex="-1" role="dialog"
                ...
                <div class="modal-dialog" role="document">
                  <form class="modal-content" action="{{ route('admin.lectures.destroy', $lecture->id) }}" method="POST">
                    <div class="modal-header">
                      <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span
                          aria-hidden="true">&times;</span></button>
