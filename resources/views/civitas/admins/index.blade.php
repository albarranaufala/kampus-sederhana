        ...
        <div class="panel-heading" style="display: flex; justify-content: space-between;">
          ...
          <div class="modal fade" id="modalCreateAdmin" tabindex="-1" role="dialog"
            ...
            <div class="modal-dialog" role="document">
              <form class="modal-content" action="{{ route('admins.store') }}" method="POST">
          ...
          <tr>
            ...
            <td>
              ...
              <div class="modal fade" id="modalUpdate{{$admin->id}}" tabindex="-1" role="dialog"
                ...
                <div class="modal-dialog" role="document">
                  <form class="modal-content" action="{{ route('admins.update', $admin->id) }}" method="POST">
                    <div class="modal-header">
                      <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span
                          aria-hidden="true">&times;</span></button>
              ...
              <div class="modal fade" id="modalDelete{{$admin->id}}" tabindex="-1" role="dialog"
                ...
                <div class="modal-dialog" role="document">
                  <form class="modal-content" action="{{ route('admins.destroy', $admin->id) }}" method="POST">
                    <div class="modal-header">
                      <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span
                          aria-hidden="true">&times;</span></button>
